/***************************************************
  ...
  ESP 8266 Air Conditioner Remote Control
...
#define AIO_SERVER      "192.168.51.185"
...
const char AIRCON_FEED[] PROGMEM = "home/air";
Adafruit_MQTT_Subscribe aircon = Adafruit_MQTT_Subscribe(&mqtt, AIRCON_FEED);
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    if (subscription == &aircon) {
      airConditioner((char *)aircon.lastread);
      }
  }
